...
<div>
	...
	<div class="page-header header">
		<form class="form-inline" role="form" method="get" id="fom" action="<?php echo $_url;?>amount/day">
			<input type="hidden" id="amountinfo_hidden" name="__my" value="amount/day" />
			<table class="search_table">
				<tr>
					<td>时间：</td>
					<td>
						<input id="begin" name="search_time" class="form-control w150" type="text" value="<?php echo $search_time;?>" placeholder="日志时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',errDealMode:1,maxDate:'%y-%M-%d'})" />
					</td>
	...
	<?php if($detail):?>
		<div class="row" style="hight:300px;">
			<div class="col-md-12" id="container_num"></div>
			<div class="col-md-8" id="container_spend"></div>
...
<script type="text/javascript">
	$('.dmain_info').live('click',function(){
		...
		var url = "<?php echo $_url;?>amount/day&search_time="+search_time+'&search_dmain='+search_dmain;
