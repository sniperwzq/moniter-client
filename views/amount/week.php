...
<div>
	...
	<div class="page-header header">
		<form class="form-inline" role="form" method="get" id="fom" action="<?php echo $_url;?>amount/week">
			<input type="hidden" id="amountinfo_hidden" name="__my" value="amount/week" />
...
<script type="text/javascript">
	$('.dmain_info').live('click',function(){
		...
		var url = "<?php echo $_url;?>amount/week&search_time="+search_time+'&search_dmain='+search_dmain;
