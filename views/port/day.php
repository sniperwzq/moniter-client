...
<div>
	...
	<div class="page-header header">
		<form class="form-inline" role="form" method="get" id="fom" action="<?php echo $_url;?>port/day">
			<input type="hidden" id="userinfo_hidden" name="__my" value="port/day" />
...
<script type="text/javascript">
	$('.inter_info').live('click',function(){
		...
		var url = "<?php echo $_url;?>port/day&search_time="+search_time+'&search_inter='+search_inter;
