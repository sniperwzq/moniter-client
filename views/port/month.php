...
<div>
	...
	<div class="page-header header">
		<form class="form-inline" role="form" method="get" id="fom" action="<?php echo $_url;?>port/month">
			<input type="hidden" id="userinfo_hidden" name="__my" value="port/month" />
...
<script type="text/javascript">
	$('.inter_info').live('click',function(){
		...
		var url = "<?php echo $_url;?>port/month&search_time="+search_time+'&search_inter='+search_inter;
