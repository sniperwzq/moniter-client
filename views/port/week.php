...
<div>
	...
	<div class="page-header header">
		<form class="form-inline" role="form" method="get" id="fom" action="<?php echo $_url;?>port/week">
			<input type="hidden" id="userinfo_hidden" name="__my" value="port/week" />
...
<script type="text/javascript">
	$('.inter_info').live('click',function(){
		...
		var url = "<?php echo $_url;?>port/week&search_time="+search_time+'&search_inter='+search_inter;
